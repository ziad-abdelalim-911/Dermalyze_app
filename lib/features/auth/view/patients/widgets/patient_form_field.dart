...
class PatientFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final labelColor = isDark ? Colors.grey.shade300 : const Color(0xFF2C4A5A);
    ...
    final textColor = isDark ? Colors.white : const Color(0xFF1A2E3B);
    final hintColor = isDark ? Colors.grey.shade500 : const Color(0xFF8A9BAB);
